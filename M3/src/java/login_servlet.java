                ...
                if(request.getParameter("button") != null)
                    {
                        ...
                        ArrayList<Utente> lista_Utenti = M3_Factory.getInstance().getListaUtenti();
                    ...
                    if(session.getAttribute("loggato") != null && session.getAttribute("loggato").equals(false))
                        request.setAttribute("ErrorMessage","Dati errati, riprova");
